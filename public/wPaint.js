...
(function($)
{
	...
	{	
		...
		generateTextInput: function()
		{
			...
			.css({display:'none', position:'absolute', color:this.settings.textColor, fontSize:this.settings.fontSize, lineHeight:this.settings.fontSize+'px', fontFamily:this.settings.fontFamily})
